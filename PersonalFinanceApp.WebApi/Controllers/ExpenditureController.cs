...
public class ExpenditureController : AttachableApiController
{
    protected override AttachmentOwnerType OwnerType => AttachmentOwnerType.AccountingDocument;

    public ExpenditureController(IMediator mediator) : base(mediator)
    {
    }
    ...
    public async Task<ActionResult<ExpenditureDetailsDto>> GetById(Guid id, CancellationToken cancellationToken)
    {
        ...
        {
            ExpenditureAccountingDocumentId = id
        }, cancellationToken);
